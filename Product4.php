...
<body>
	...
	<div id="content-wrapper">
		...
		<div class="column">
			<img id=featured src="images/AS4.png">
			...
			<div id="slide-wrapper" >
				...
				<div id="slider">
					<img class="thumbnail active" src="images/AS4.png">
					<img class="thumbnail" src="images/AS4_1.png">
					<img class="thumbnail" src="images/AS4_2.png">

					<img class="thumbnail" src="images/AS4_3.png">
					<img class="thumbnail" src="images/AS4_4.png">
					<img class="thumbnail" src="images/AS4_5.png">
					<img class="thumbnail" src="images/AS4_6.png">
				</div>
